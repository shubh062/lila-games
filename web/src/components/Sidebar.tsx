    ...
    <aside className="w-80 bg-zinc-950 flex flex-col shrink-0 text-sm overflow-hidden">
        ...
        <div className="space-y-2 pt-2 border-t border-zinc-800/50">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-3 gap-1.5">
              ...
              ].map(({ id, label, Icon, activeColor, bgColor, borderColor }) => {
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-1">
        ...
        {filteredMatches.slice(0, 50).map((match) => (
          ...
          >
            <div className="font-mono text-xs text-zinc-300 truncate mb-1.5 group-hover:text-cyan-400 transition-colors">
